...
<!--this is version from commit 5f9f16b2229ee748fd48c9f665b7783c3182a754 -->
...
// this if block ends at the very end of this file, after all class and function declarations.
    define('BIBTEXBROWSER','v5f9f16b2229ee748fd48c9f665b7783c3182a754');
...
// should Latex macros be executed (e.g. \'e -> �
...
// ----------------------------------------------------------------------
    ...
    if (!function_exists('poweredby')) {
        ...
        function poweredby() {
            ...
            $poweredby .= 'Powered by <a href="http://www.monperrus.net/martin/bibtexbrowser/">bibtexbrowser</a><!--v5f9f16b2229ee748fd48c9f665b7783c3182a754-->';
            $poweredby .= '</div>'."\n";
            return $poweredby;
        }
    }
...
// the HTTP header is taken into account, not the <meta http-equiv>
        ...
        <head>
            ...
            <meta name="generator" content="bibtexbrowser v5f9f16b2229ee748fd48c9f665b7783c3182a754" />
            <?php
...
//
            ...
            <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
                <channel>
                    ...
                    <generator>bibtexbrowser v5f9f16b2229ee748fd48c9f665b7783c3182a754</generator>
    ...
    class Dispatcher {
        ...
        function diagnosis() {
            ...
            echo "bibtexbrowser version: 5f9f16b2229ee748fd48c9f665b7783c3182a754\n";
