    ...
    <nav class="navbar navbar-default navbar-static-top">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="?Index"><img src="img/logo.png" alt="Access" height="50"
                                                           width="auto"/></a>
                <a class="navbar-brand" href="?DecisionMaking"><img src="img/decisionsupport.png" alt="DecisionSupport"
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="?AdminAuthenticationFeatureOverview">Change Subfeatures of Authentication
                                        Schemes</a></li>
                                <li><a href="?AdminScaleValuesOverview">Change Scale Values</a></li>
                                <li><a href="?AdminClassifyAuthenticationsFeatureOverview">Classify Authentication
                                        Schemes</a></li>
                                <li><a href="?AdminPerformancesOverview">Set/Check Performances in Features</a></li>
                                <li><a href="?AdminSuggestionOverview">Suggestion Overview</a></li>
                                <li role="separator" class="divider"></li>
                                ...
                                <li><a href="?AdminInviteOverview">Manage Invite-Codes</a></li>
                                <li role="separator" class="divider"></li>
